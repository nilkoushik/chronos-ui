...
export default function RichTextEditor(props: RichTextEditorProps) {
  ...
  return (
    ...
    >
      {/* Fluid Toolbar container */}
      <div class="editor-toolbar flex flex-wrap gap-x-4 gap-y-3 p-4 bg-[#f8fafc] border-b border-[var(--border)] select-none sticky top-0 z-10 w-full" style={{ borderBottom: '1px solid #e2e8f0', alignItems: 'center' }}>
        ...
        {/* Pushes the input to the right if there's available space, but stays inline if wrapped */}
        <div class="ml-auto flex items-center bg-white border border-slate-300 rounded-md px-3 py-1.5 shadow-sm focus-within:border-indigo-400 focus-within:ring-1 focus-within:ring-indigo-400 transition-all">
