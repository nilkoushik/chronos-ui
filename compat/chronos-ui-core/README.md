...
Then update import specifiers from `@chronos-ui/core/...` to `@contentvidya/ui/...`. See the [migration guide](https://github.com/nilkoushik/contentvidya-ui/blob/master/docs/MIGRATION-CONTENTVIDYA.md) for the full timeline, a codemod, and package.json examples.
...
See [`MIGRATION-CONTENTVIDYA.md`](https://github.com/nilkoushik/contentvidya-ui/blob/master/docs/MIGRATION-CONTENTVIDYA.md) — in short: fully functional now (`v1.4.2`), registry-marked deprecated at `v1.5.0`, capped/frozen at `v2.0.0` with an announced end-of-support date.
