...
// @contentvidya/ui compat wrapper's version and its dependency pin on
...
const wrapperDir = path.join(__dirname, '..', 'compat', 'contentvidya-ui-core');
...
console.log(`[publish-compat-wrapper] @contentvidya/ui -> ${version} (forwarding to @contentvidya/ui@${version})`);
